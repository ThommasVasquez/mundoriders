...
import { Flame, User, LogOut, MessageSquare, Compass, Bell, Sun, Moon, Store, Users, Bookmark, Wrench, Sliders, Gauge, Search } from "lucide-react"
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-primary-orange/50 hover:bg-white/10 text-text-muted hover:text-white transition-all text-xs cursor-pointer group w-36 sm:w-48 md:w-64"
              >
                <Search className="w-4 h-4 text-primary-orange group-hover:scale-110 transition-transform flex-shrink-0" />
                <span className="truncate">Buscar compas, grupos, tiendas...</span>
              </button>
